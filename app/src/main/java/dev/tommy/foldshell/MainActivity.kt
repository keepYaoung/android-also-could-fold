...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        root.addView(mode)
        label("V2: 커버는 왼쪽 변, 내부 왼쪽 화면은 가운데 접힘선을 고정하고 바깥쪽을 후퇴시킵니다. 자이로 회전량에 따라 움직이며 1.5초 정지 시 해제합니다. 잠금 화면도 보호 영역을 제외한 메모리 캡처를 시도하고, 차단되면 검은 원근 마스크를 표시합니다. 캡처는 저장·전송하지 않습니다. 끄면 V1 블러로 돌아갑니다.", 14f)
