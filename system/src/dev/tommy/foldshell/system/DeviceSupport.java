...
public final class DeviceSupport {
    ...
    /** Galaxy Z Fold7 (SM-F966x, verified on SM-F966N), Galaxy Z Fold8 (SM-F971x, reported by a
     *  tester on SM-F971B) and Galaxy Z Fold8 Ultra (SM-F976x). Fold8 models are unverified. */
    public static final String[] FAMILIES = {"SM-F966", "SM-F971", "SM-F976"};
